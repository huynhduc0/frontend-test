...
class Header extends Component {
    ...
    componentDidMount() {
        ...
        //             user: user
        //         });
        //         datas.ref('users').child(user.uid).on("value", snapshot => {
        ...
        return (
            <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    {this.state.user !== {} ?<li className="nav-item dropdown no-arrow">
                        <a className="nav-link dropdown-toggle" href="https://www.facebook.com/" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span className="mr-2 d-none d-lg-inline text-gray-600 small">{this.state.user ? this.state.user.displayName : this.state.user.email}</span>
                            <img className="img-profile rounded-circle" src={this.state.user.photoURL ? this.state.user.photoURL : "https://m2bob-forum.net/wcf/images/avatars/3e/2720-3e546be0b0701e0cb670fa2f4fcb053d4f7e1ba5.jpg"} alt="ahihi" />
                        </a>
                        <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            ...
                            <a className="dropdown-item" href="https://www.facebook.com/"
                             data-toggle="modal" data-target="#logoutModal" onClick={() => {handleSignout(this.state.role); this.props.history.push("/login") }}>
